...
export function getStatusColor(status) {
  switch (status) {
    ...
    case 'd': return '#FFD700'; // doubtful
    case 'i': return '#ff4444'; // injured
    case 's': return '#ff4444'; // suspended
    case 'u': return '#ff4444'; // unavailable
    default: return null;
  }
}
...
export function getStatusBadgeClass(status) {
  switch (status) {
    ...
    case 'u': return 'bg-orange-500 text-white';
